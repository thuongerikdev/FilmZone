...
namespace FZ.Auth.ApplicationService.Billing.PaymentModule
{
    public class VnPayLibrary
    {
        ...
        public PaymentResponseModel GetFullResponseData(IQueryCollection colleion, string hashSecret)
        {
            var vnPay = new VnPayLibrary();
            foreach (var (key, value) in colleion)
            {
            ...
            return new PaymentResponseModel()
            {
                ...
                TransaionId = vnPayTranId.ToString(),
                Token = vnpSecureHash,
