...
const PriceManagement = ({ colors, planId, prices = [], onPricesUpdate }) => {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === "isActive" ? e.target.checked : name === "amount" || name === "intervalCount" || name === "trialDays" ? Number(value) : value,
    }));
  };
