...
export const getCommentsByUserId = userID => {
    const token = localStorage.getItem('token');
    return api.get(`/api/Comment/GetCommentsByUserID/${userID}?userID=${userID}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getEpisodeSourcesByEpisodeId = episodeId => {
    const token = localStorage.getItem('token');
    return api.get(`/movie/EpisodeSource/GetEpisodeSourcesByEpisodeId/${episodeId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const createEpisodeWatchProgress = data => {
    const token = localStorage.getItem('token');
    return api.post("/api/EpisodeWatchProgress/CreateEpisodeWatchProgress", data, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const updateEpisodeWatchProgress = data => {
    const token = localStorage.getItem('token');
    return api.put("/api/EpisodeWatchProgress/UpdateEpisodeWatchProgress", data, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const deleteEpisodeWatchProgress = id => {
    const token = localStorage.getItem('token');
    return api.delete(`/api/EpisodeWatchProgress/DeleteEpisodeWatchProgress/${id}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getEpisodeWatchProgressById = id => {
    const token = localStorage.getItem('token');
    return api.get(`/api/EpisodeWatchProgress/GetEpisodeWatchProgressByID/${id}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getEpisodeWatchProgressByUserId = userId => {
    const token = localStorage.getItem('token');
    return api.get(`/api/EpisodeWatchProgress/GetEpisodeWatchProgressByUserID/user/${userId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getEpisodeWatchProgressByEpisodeId = episodeId => {
    const token = localStorage.getItem('token');
    return api.get(`/api/EpisodeWatchProgress/GetEpisodeWatchProgressByEpisodeID/episode/${episodeId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const logoutSession = sessionId => {
    const token = localStorage.getItem('token');
    return api.post(`/login/logout/session/${sessionId}`, {}, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getAllMoviesNewReleaseMainScreen = () => {
    const token = localStorage.getItem('token');
    return api.get("/api/Movie/GetAllMoviesNewReleaseMainScreen/newReleaseMainScreen", {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getMoviesByRegionId = regionID => {
    const token = localStorage.getItem('token');
    return api.get(`/movie/Region/GetMovieByRegionID/getMovieByRegionID/${regionID}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getPersonsByRegionId = regionID => {
    const token = localStorage.getItem('token');
    return api.get(`/movie/Region/GetPersonByRegionID/getPersonByRegionID/${regionID}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getWatchProgressByMovieId = movieId => {
    const token = localStorage.getItem('token');
    return api.get(`/movie/WatchProgress/GetWatchProgressByMovieId/${movieId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getAllSubtitlesByMovieSourceId = (sourceId) => {
    const token = localStorage.getItem('token');
    return api.get(`/api/MovieSubTitle/GetAllSubTitlesByMovieId/movie/GetAllSubTitlesBySourceID/${sourceId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getAllSubtitlesByEpisodeSourceId = (sourceId) => {
    const token = localStorage.getItem('token');
    return api.get(`/api/MovieSubTitle/GetAllSubTitlesByEpisodeId/episode/GetAllSubTitlesBySourceID/${sourceId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const getMovieSourcesByMovieId = (movieId) => {
    const token = localStorage.getItem('token');
    return api.get(`/movie/MovieSource/GetMovieSourcesByMovieIdPublic/getByMovieId/${movieId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
...
export const translateSubtitleFromSource = (data) => {
    const token = localStorage.getItem('token');
    return api.post('/api/MovieSubTitle/TranslateFromSource/Translate/AutoFromSource', data, {
        headers: { 'Authorization': `Bearer ${token}` }
    });
};
